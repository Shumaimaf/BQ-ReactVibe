...
export default function ProductCategoryPage() {
  ...
  return (
    <div className='container' style={{ fontFamily: "'Playfair', serif", textTransform: "capitalize", marginBottom: "10px", paddingBottom: "50px" }}>
      <div className="my-5 text-center">
        <h2 className='fs-2 text-center mb-1 align-items-center fw-semibold' style={{ fontFamily: "'Cinzel', serif", width: "100%", letterSpacing: '2px' }}>{categoryName}</h2>
