...
var FormLabel = React6.forwardRef(({
  ...
  htmlFor = htmlFor || controlId;
  if (column)
    return (0, import_jsx_runtime8.jsx)(Col_default, {
      ref,
      as: "label",
      className: classes,
      htmlFor,
...
var FormRange = React7.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
...
var FormSelect = React8.forwardRef(({
  bsPrefix,
  size,
  htmlSize,
  className,
...
var FormText = React9.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var Switch = React10.forwardRef((props, ref) => (0, import_jsx_runtime12.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
//# sourceMappingURL=chunk-MQLABAAX.js.map
