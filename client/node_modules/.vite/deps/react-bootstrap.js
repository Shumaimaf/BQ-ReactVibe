...
import {
  ...
  useForceUpdate,
  useNavItem
} from "./chunk-PURHXPBG.js";
import {
  SelectableContext_default,
  makeEventKey
} from "./chunk-RXTZ2WRF.js";
import {
  NavbarContext_default
} from "./chunk-ML4JCIDL.js";
import {
  dataAttr,
  qsa
...
import {
  PageItem_default,
  Pagination_default
} from "./chunk-RYC2HSGH.js";
import {
  Row_default
} from "./chunk-QCO4NJWT.js";
import {
...
import {
  ...
  ownerDocument,
  safeFindDOMNode
} from "./chunk-M3RUEIV4.js";
import {
  require_browser,
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-CTSCW4VX.js";
import {
  useMergedRefs_default
} from "./chunk-GHBRSVGE.js";
import {
  Anchor_default,
  useEventListener
} from "./chunk-J3AH57K5.js";
import {
  useCallbackRef
...
import {
  ...
  Form_default,
  require_warning
} from "./chunk-MQLABAAX.js";
import {
  forEach,
  map
} from "./chunk-24RKHN32.js";
import {
  createWithBsPrefix
...
import {
  Image_default,
  propTypes
} from "./chunk-BJEYJ466.js";
import {
  require_prop_types
} from "./chunk-IFLIF665.js";
import "./chunk-LWE27YI4.js";
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  const wasPropRef = (0, import_react6.useRef)(propValue !== void 0);
  const [stateValue, setState] = (0, import_react6.useState)(defaultValue);
  ...
  return [isProp ? propValue : stateValue, (0, import_react6.useCallback)((...args) => {
...
function useSafeState(state) {
  ...
  return [state[0], (0, import_react7.useCallback)((nextState) => {
    if (!isMounted())
      return;
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  const prevModifiers = (0, import_react8.useRef)(modifiers);
  const popperInstanceRef = (0, import_react8.useRef)();
  const update = (0, import_react8.useCallback)(() => {
    var _popperInstanceRef$cu;
    (_popperInstanceRef$cu = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu.update();
  }, []);
  const forceUpdate = (0, import_react8.useCallback)(() => {
    var _popperInstanceRef$cu2;
    (_popperInstanceRef$cu2 = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu2.forceUpdate();
  }, []);
  const [popperState, setState] = useSafeState_default((0, import_react8.useState)({
    placement,
    update,
    forceUpdate,
    attributes: {},
  ...
  const updateModifier = (0, import_react8.useMemo)(() => ({
  ...
  const nextModifiers = (0, import_react8.useMemo)(() => {
...
function useClickOutside(ref, onClickOutside = noop, {
  ...
  const preventMouseClickOutsideRef = (0, import_react9.useRef)(false);
  const waitingForTrigger = (0, import_react9.useRef)(false);
  const handleMouseCapture = (0, import_react9.useCallback)((e) => {
...
function useDropdownMenu(options = {}) {
  const context4 = (0, import_react10.useContext)(DropdownContext_default);
  const [arrowElement, attachArrowRef] = useCallbackRef();
  const hasShownRef = (0, import_react10.useRef)(false);
  const {
    flip: flip2,
    offset: offset2,
    rootCloseEvent,
...
var $704cf1d3b684cc5c$var$SSRContext = (0, import_react11.default).createContext($704cf1d3b684cc5c$var$defaultContext);
function $704cf1d3b684cc5c$var$LegacySSRProvider(props) {
  let cur = (0, import_react11.useContext)($704cf1d3b684cc5c$var$SSRContext);
  let counter = $704cf1d3b684cc5c$var$useCounter(cur === $704cf1d3b684cc5c$var$defaultContext);
  let [isSSR, setIsSSR] = (0, import_react11.useState)(true);
  let value = (0, import_react11.useMemo)(() => ({
  ...
  return (0, import_react11.default).createElement($704cf1d3b684cc5c$var$SSRContext.Provider, {
    value
  }, props.children);
}
var $704cf1d3b684cc5c$var$warnedAboutSSRProvider = false;
function $704cf1d3b684cc5c$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, import_react11.default)["useId"] === "function") {
    if (!$704cf1d3b684cc5c$var$warnedAboutSSRProvider) {
      console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
      $704cf1d3b684cc5c$var$warnedAboutSSRProvider = true;
    }
    return (0, import_react11.default).createElement((0, import_react11.default).Fragment, null, props.children);
  }
  return (0, import_react11.default).createElement($704cf1d3b684cc5c$var$LegacySSRProvider, props);
}
...
function $704cf1d3b684cc5c$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react11.useContext)($704cf1d3b684cc5c$var$SSRContext);
...
function $704cf1d3b684cc5c$var$useModernSSRSafeId(defaultId) {
  let id = (0, import_react11.default).useId();
  let [didSSR] = (0, import_react11.useState)($704cf1d3b684cc5c$export$535bd6ca7f90a273());
  let prefix = didSSR ? "react-aria" : `react-aria${$704cf1d3b684cc5c$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id}`;
}
var $704cf1d3b684cc5c$export$619500959fc48b26 = typeof (0, import_react11.default)["useId"] === "function" ? $704cf1d3b684cc5c$var$useModernSSRSafeId : $704cf1d3b684cc5c$var$useLegacySSRSafeId;
...
function $704cf1d3b684cc5c$export$535bd6ca7f90a273() {
  if (typeof (0, import_react11.default)["useSyncExternalStore"] === "function")
    return (0, import_react11.default)["useSyncExternalStore"]($704cf1d3b684cc5c$var$subscribe, $704cf1d3b684cc5c$var$getSnapshot, $704cf1d3b684cc5c$var$getServerSnapshot);
  let cur = (0, import_react11.useContext)($704cf1d3b684cc5c$var$SSRContext);
  return cur.isSSR;
}
...
function useDropdownToggle() {
  ...
  const {
    ...
    setToggle,
    menuElement
  } = (0, import_react12.useContext)(DropdownContext_default) || {};
  const handleClick = (0, import_react12.useCallback)((e) => {
    toggle(!show, e);
  }, [show, toggle]);
  const props = {
    id,
...
function useDropdownItem({
  ...
  const navContext = (0, import_react13.useContext)(NavContext_default);
  const {
    activeKey
  } = navContext || {};
...
function useRefWithUpdate() {
  ...
  const attachRef = (0, import_react14.useCallback)((element) => {
    ref.current = element;
    forceUpdate();
  }, [forceUpdate]);
...
function Dropdown({
  ...
  const lastSourceEvent = (0, import_react14.useRef)(null);
  const focusInDropdown = (0, import_react14.useRef)(false);
  const onSelectCtx = (0, import_react14.useContext)(SelectableContext_default);
  const toggle = (0, import_react14.useCallback)((nextShow, event, source = event == null ? void 0 : event.type) => {
    onToggle(nextShow, {
      originalEvent: event,
      source
    });
  ...
  const context4 = (0, import_react14.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
  ...
  useEventListener((0, import_react14.useCallback)(() => window2.document, [window2]), "keydown", (event) => {
...
function useWrappedRefWithWarning(ref, componentName) {
  if (false)
    return ref;
  const warningRef = (0, import_react15.useCallback)((refValue) => {
...
var DropdownMenu2 = React23.forwardRef(({
  ...
  let alignEnd = false;
  const isNavbar = (0, import_react16.useContext)(NavbarContext_default);
  const prefix = useBootstrapPrefix(bsPrefix, "dropdown-menu");
  const {
    align: contextAlign,
    drop,
    isRTL
  } = (0, import_react16.useContext)(DropdownContext_default2);
...
var DropdownToggle2 = React24.forwardRef(({
  ...
  const dropdownContext = (0, import_react17.useContext)(DropdownContext_default);
...
var FigureImage = React27.forwardRef(({
  className,
  fluid = true,
  ...props
}, ref) => (0, import_jsx_runtime26.jsx)(Image_default, {
  ref,
  ...props,
  fluid,
...
var InputGroupCheckbox = (props) => (0, import_jsx_runtime27.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime27.jsx)(FormCheckInput_default, {
    type: "checkbox",
    ...props
  })
});
var InputGroupRadio = (props) => (0, import_jsx_runtime27.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime27.jsx)(FormCheckInput_default, {
    type: "radio",
    ...props
  })
...
var InputGroup = React28.forwardRef(({
  ...
  return (0, import_jsx_runtime27.jsx)(InputGroupContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime27.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames18.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, hasValidation && "has-validation")
    })
  });
});
...
var ListGroupItem = React29.forwardRef(({
  bsPrefix,
  active,
  disabled,
  eventKey,
...
var ListGroup = React30.forwardRef((props, ref) => {
  const {
    className,
...
var NavDropdown = React31.forwardRef(({
  ...
  return (0, import_jsx_runtime31.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames21.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime30.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime30.jsx)(Dropdown_default2.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
var Popover = React34.forwardRef(({
  ...
  return (0, import_jsx_runtime33.jsxs)("div", {
    ref,
    role: "tooltip",
    style: computedStyle,
    "x-placement": primaryPlacement,
    className: (0, import_classnames22.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
    children: [(0, import_jsx_runtime32.jsx)("div", {
      className: "popover-arrow",
      ...arrowProps
    }), body ? (0, import_jsx_runtime32.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
var Tooltip = React35.forwardRef(({
  ...
  return (0, import_jsx_runtime35.jsxs)("div", {
    ...
    role: "tooltip",
    "x-placement": primaryPlacement,
    className: (0, import_classnames23.default)(className, bsPrefix, `bs-tooltip-${bsDirection}`),
    ...props,
...
var Overlay2 = React36.forwardRef(({
  ...
  return (0, import_jsx_runtime36.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
    ...
    children: (overlayProps, {
      ...
      return React36.cloneElement(overlay, {
        ...
        popper: popper2,
        hasDoneInitialMeasure,
        className: (0, import_classnames24.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime39.jsxs)(import_jsx_runtime38.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react24.cloneElement)(children, triggerProps), (0, import_jsx_runtime37.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames25.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React38.forwardRef((props, ref) => {
  const placeholderProps = usePlaceholder(props);
  return (0, import_jsx_runtime40.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var Placeholder = React39.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime42.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames26.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
    ...
    "aria-valuemin": min2,
    "aria-valuemax": max2,
    children: visuallyHidden ? (0, import_jsx_runtime42.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
}
var ProgressBar = React40.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
...
var Ratio = React41.forwardRef(({
  ...
  return (0, import_jsx_runtime43.jsx)("div", {
    ...
    className: (0, import_classnames27.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
    children: React41.Children.only(children)
  });
});
...
var Spinner = React42.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size,
  ...
  return (0, import_jsx_runtime44.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames28.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
var SplitButton = React43.forwardRef(({
  id,
  bsPrefix,
  size,
  variant,
  ...
  children: [(0, import_jsx_runtime45.jsx)(Button_default2, {
    size,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime45.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size,
    variant,
  ...
  }), (0, import_jsx_runtime45.jsx)(Dropdown_default2.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip: flip2,
...
var Stack = React44.forwardRef(({
  ...
  return (0, import_jsx_runtime47.jsx)(Component2, {
    ...props,
    ref,
    className: (0, import_classnames29.default)(className, bsPrefix, ...createUtilityClassName({
      gap
...
var TabPanel = React45.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
    ...
    return (0, import_jsx_runtime48.jsx)(TabContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime48.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime48.jsx)(Transition, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime48.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime50.jsx)(Tabs_default, {
  ...props,
...
var TabPane = React48.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime51.jsx)(TabContext_default.Provider, {
    value: null,
    children: (0, import_jsx_runtime51.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime51.jsx)(Transition, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
        ...
        children: (0, import_jsx_runtime51.jsx)(Component2, {
          ...rest,
          ref,
          className: (0, import_classnames30.default)(className, prefix, isActive && "active")
        })
      })
    })
  });
...
var Tab = () => {
  ...
  return (0, import_jsx_runtime53.jsx)(import_jsx_runtime52.Fragment, {});
};
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime54.jsx)(NavItem_default, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime54.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime55.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime54.jsx)(Nav_default2, {
      ...controlledProps,
      role: "tablist",
      as: "ul",
      variant,
      children: map(children, renderTab)
    }), (0, import_jsx_runtime54.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime54.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React51.forwardRef((props, ref) => (0, import_jsx_runtime56.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React52.createContext({
...
var ToastHeader = React53.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  return (0, import_jsx_runtime58.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames31.default)(bsPrefix, className),
...
var Toast = React54.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime59.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames32.default)(bsPrefix, className, bg && `bg-${bg}`, !hasAnimation && (show ? "show" : "hide")),
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true"
  });
  return (0, import_jsx_runtime59.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime59.jsx)(Transition, {
      in: show,
      unmountOnExit: true,
      children: toast
    }) : toast
...
var ToastContainer = React55.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
  ...
  return (0, import_jsx_runtime60.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames33.default)(bsPrefix, position && positionClasses[position], containerPosition && `position-${containerPosition}`, className)
  });
});
...
var noop5 = () => void 0;
var ToggleButton = React56.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
  ...
  return (0, import_jsx_runtime63.jsxs)(import_jsx_runtime62.Fragment, {
    children: [(0, import_jsx_runtime61.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime61.jsx)(Button_default2, {
      ...props,
      ref,
      className: (0, import_classnames34.default)(className, disabled && "disabled"),
      type: void 0,
      role: void 0,
      as: "label",
      htmlFor: id
...
var ToggleButtonGroup = React57.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
  ...
  return (0, import_jsx_runtime64.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
